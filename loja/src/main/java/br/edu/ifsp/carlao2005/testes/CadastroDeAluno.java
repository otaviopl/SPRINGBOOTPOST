...
public class CadastroDeAluno {
    ...
    public static void alterarAluno(EntityManager em) {
        ...
        if (aluno != null) {
            ...
            do {
                System.out.println("O que gostaria de mudar nesse aluno:\n" +
                        "1->Nota1:\n2->Nota2:\n3->Nota3:\n 4->Sair");
                ...
                switch (choice) {
                    case 1:
                        System.out.println("Mudando nota1->");
                        BigDecimal novaNota1 = new BigDecimal(scanner.nextLine());
                        aluno.setNota1(novaNota1);
                        break; // Não esqueça de adicionar o break para sair do switch

                    case 2:
                        System.out.println("Mudando nota2->");
                        BigDecimal novaNota2 = new BigDecimal(scanner.nextLine());
                        aluno.setNota2(novaNota2);
                        break;

                    case 3:
                        System.out.println("Mudando nota3->");
                    ...
                    default:
                        throw new IllegalStateException("Decisão inválida: " + choice);
                }
            } while (choice != 3);
